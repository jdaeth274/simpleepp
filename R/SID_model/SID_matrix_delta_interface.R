...
expose_stan_functions("~/Dropbox/jeff_hiv_work/simpleepp/stan_files/chunks/SID_models/SID_model_matrix_delta.stan")
...
run_simulated_model<-function(params,times){
  ...
  delta_single <- rlogistic(step_vector, delta_ps)
  
  delta <- matrix(data = 0, nrow = 4, ncol = length(kappa))
...
test_stan_hiv<- stan("~/Dropbox/jeff_hiv_work/simpleepp/stan_files/chunks/SID_models/SID_model_matrix_delta.stan",
                     data = stan_data_discrete,
                     pars = params_monitor_hiv,
                     chains = 1, iter = 10)  

Sys.time()
mod_hiv_prev_pen_2 <- stan("~/Dropbox/jeff_hiv_work/simpleepp/stan_files/chunks/SID_models/SID_model_matrix_delta.stan",
                           data = stan_data_discrete,
